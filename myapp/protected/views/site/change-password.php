<div id="main_form">
	<div style="margin-bottom: 30px;">Change password.</div>
	<div>Old Password</div>
	<div>
		<input type="password" id="old_pwd" class="big-textbox" />
	</div>
...
function validateLogin() {
	...
	if (oldpwd == "") {
		...
		errMsg = "New Password - Verify is required.";
		focus = 'pwd-verify';
		result = false;
		
	} else if (pwd !== pwdVerify) {
		errMsg = "New Password - Verify is not match.";
		focus = 'pwd-verify';
		result = false;
	}
